...
namespace Business.Concrete
{
    ...
    {
        private IUser2Service _userService;
        private ITokenHelper _tokenHelper;

        public AuthManager(IUser2Service userService, ITokenHelper tokenHelper)
        {
        ...
        public IDataResult<User2> Register(UserForRegisterDto userForRegisterDto, string password)
        {
            ...
            return new SuccessDataResult<User2>(user, Messages.UserRegistered);
        }
        ...
        public IDataResult<AccessToken> CreateAccessToken(User2 user)
        {
